...
const videos = [
  {
    videoId: "v1",
    title: "IND vs PAK 2022 | Virat Kohli’s Unbelievable Knock at Melbourne!",
    thumbnailUrl: thumb1,
    videoUrl: video1,
    duration: "00:20",
  ...
  {
    videoId: "v2",
    title: "मौन रहो, अकेले रहो, फिर देखो क्या चमत्कार होता है आपके साथ ! // Shri Hit Premanand Ji Maharaj",
    thumbnailUrl: thumb2,
    videoUrl: video2,
    duration: "04:44",
  ...
  {
    videoId: "v3",
    title: "Complete Placement Preparation: DSA + Web Development + Aptitude | New Sigma 11 & Sigma Prime 🚀",
    thumbnailUrl: thumb3,
    videoUrl: video3,
    duration: "02:26",
  ...
  {
    videoId: "v6",
    title: "Premanand Ji Maharaj Pravachan | हर रोज़ पढ़ने से पहले ये सुनो, पढ़ाई अपने आप लगने लगेगा",
    thumbnailUrl: thumb6,
    videoUrl: video6,
    duration: "03:52",
  ...
  {
    videoId: "v7",
    title: "जब जीवन में बहुत दुखी हों, परेशान हों, विपत्ति मे हों, हार गये हों तो ये सुनो !!",
    thumbnailUrl: thumb7,
    videoUrl: video7,
    duration: "03:35",
  ...
  {
    videoId: "v9",
    title: "Goosebumps Don’t miss the end | RCB vs PBKS IPL Final 2025 Cinematic Vlog | Narendra Modi Stadium",
    thumbnailUrl: thumb9,
    videoUrl: video9,
    duration: "00:33",
